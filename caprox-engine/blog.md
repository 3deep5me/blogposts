...
To do so, execute these commands on your Proxmox node:
    ...
    spec:
      template:
        spec:
          ...
          containers:
          - name: image-builder
            # until https://github.com/kubernetes-sigs/image-builder/pull/1778 is released
            image: docker.io/3deep5me/image-builder:dev
            envFrom:
            - secretRef:
                name: proxmox-image-build-config
            args:
